...
<script>	 
	function get_subject_syllabus(subject_group_subject_id,new_date,time_from,time_to,subject_group_class_section_id){
		...
		$.ajax({
            ...
            data: {'subject_group_subject_id': subject_group_subject_id,'new_date':new_date,'time_from':time_from,'time_to':time_to,'subject_group_class_section_id':subject_group_class_section_id},           
