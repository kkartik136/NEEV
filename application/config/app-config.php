...
$config['file_validate'] = array(
    ...
    'allowed_extension' => array('pdf', 'doc', 'xls','ppt' ,'docx', 'xlsx','pptx' , 'jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'mp3', 'aac', 'mp4', 'mpg', '3gp', 'webm', 'avi', 'wmv', 'mov', 'PDF', 'DOC', 'XLS', 'DOCX', 'XLSX', 'JPG', 'JPEG', 'PNG', 'GIF', 'BMP', 'SVG', 'MP3', 'AAC', 'MP4', 'MPG', '3GP', 'WEBM', 'AVI', 'WMV', 'MOV', 'Pdf', 'Doc', 'Xls', 'Docx', 'Xlsx', 'Jpg', 'Jpeg', 'Png', 'Gif', 'Bmp', 'Svg', 'Mp3', 'Aac', 'Mp4', 'Mpg', '3Gp', 'Webm', 'Avi', 'Wmv', 'Mov','mkv'), // image extensions
    'upload_size'       => 100048576, // bytes
);
